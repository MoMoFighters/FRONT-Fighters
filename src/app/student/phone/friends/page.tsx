...
export default function MyFriends() {
    ...
    const friendInfo2: friendInfo = { name: '이요청', profile: '프사', status: { mode: 'friend' } }
    const friendInfo3: friendInfo = { name: '박보냄', profile: '프사', status: { mode: 'friend' } }
    const friendInfo4: friendInfo = { name: '최검색', profile: '프사', status: { mode: 'friend' } }
    const friendInfo5: friendInfo = { name: '정차단', profile: '프사', status: { mode: 'friend' } }
