...
export default async function StudentTestPage() {
    ...
    const userData = {
        ...
        isTempPwd: userInfo?.isTempPwd || false,
        createdAt: userInfo?.createdAt || new Date().toISOString(),
        points: userInfo?.points ?? 0,
        buildings: userInfo?.buildingInfos.length ?? 0,
    };
                ...
                <aside className="sticky top-8 mb-auto w-68 shrink-0 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                    <div className="border-b border-slate-100 p-6">
                        <div className="flex items-center gap-4">
                            <div className="relative flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-slate-100 text-slate-400 ring-1 ring-slate-200">
                    ...
                    <nav className="p-3">
                        <ul className="space-y-1 text-sm font-bold text-slate-500">
                            <li className="flex items-center gap-3 rounded-2xl px-4 py-3 transition hover:bg-slate-50 hover:text-slate-900">
