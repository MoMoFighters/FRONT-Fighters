...
import { AccessLog, Action } from "@/features/admin/access-log/type";
...
export default function AdminAccessLogItem({
    ...
    const isUserAccess = log.userId !== undefined && log.userId !== null;
    const isSuccess = log.action !== "FORBIDDEN";
        ...
        <article>
            ...
            >
                ...
                <time className="text-slate-500">
                    {formatAdminDateTime(log.accessedAt)}
                </time>
