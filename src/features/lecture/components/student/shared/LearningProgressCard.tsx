            ...
            <div className="mt-5 flex flex-col items-center">
                ...
                >
                    <div className="flex h-[clamp(4.5rem,31cqw,7rem)] w-[clamp(4.5rem,31cqw,7rem)] flex-col items-center justify-center rounded-full bg-white shadow-inner">
                        ...
                        <span className="mt-1 text-[clamp(0.75rem,1.6cqw,0.75rem)] font-bold text-slate-400">
                            전체 진도율
                        </span>
                    </div>
                </div>

                <p className="mt-5 text-center text-[clamp(0.8125rem,1.8cqw,0.875rem)] font-medium leading-6 text-slate-500">
