...
export default function GuestInquiryCard() {
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center gap-2 text-[clamp(0.75rem,3cqw,0.75rem)] font-bold text-slate-500">
        <CircleQuestionMark className="h-[clamp(0.875rem,4cqw,1rem)] w-[clamp(0.875rem,4cqw,1rem)] text-indigo-400" />
        1:1 문의
      </div>

      <div className="flex items-center justify-between gap-2">
        <p className="text-[clamp(0.75rem,3cqw,0.75rem)] leading-5 text-slate-600">
        ...
        <button
          ...
          className="min-w-16 shrink-0 cursor-pointer rounded-lg border border-indigo-400 bg-white px-1.5 py-1.5 text-[clamp(0.75rem,3cqw,0.75rem)] font-bold text-indigo-600 transition-colors hover:bg-indigo-50"
        >
          문의하기
        </button>
      </div>
