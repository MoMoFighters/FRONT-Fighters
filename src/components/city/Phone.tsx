...
export default function Phone({
    ...
    return (
        <div
            className="group fixed -bottom-[320px] right-[8%] z-30 h-[320px] w-[168px] transition-[bottom] duration-500 ease-out hover:-bottom-6 focus-within:-bottom-4 sm:-bottom-[370px] sm:h-[440px] sm:w-[230px]"
