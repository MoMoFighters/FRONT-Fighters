export default function MyInfoTable({ data }: {
    data: {
        name: string;
        nickname: string;
        createdAt: number;
    ...
    return (
        <div className="grid grid-rows-3 mt-4 rounded-md overflow-hidden border border-slate-300">
            ...
            <div className="flex flex-row border-b border-slate-300">
                ...
                <div className="flex-1 flex items-center w-26 p-3 font-semibold bg-slate-50">
                    <p className="my-auto text-slate-900">{data?.points.toLocaleString() || 0} P</p>
                </div>
            </div>
            <div className="flex flex-row">
                ...
                <div className="flex-1 flex items-center w-26 p-3 font-semibold bg-slate-50">
                    <p className="my-auto text-slate-900">{data?.buildings || 0} 개</p>
                </div>
            </div>
        </div>
    );
