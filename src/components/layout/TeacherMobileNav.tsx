                    ...
                    {TEACHER_NAV_ITEMS.map((item) => {
                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-black transition ${isActive ? "bg-indigo-50 text-indigo-500" : "text-slate-500 hover:bg-slate-50 hover:text-slate-900"}`}
                            >
